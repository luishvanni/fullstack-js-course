function addContact() {
    ...
    nameLi.appendChild(nameInput) //vai salvar o input nos itens da lista(li)
    ul.appendChild(nameLi) //vai salvar os itens da lista na lista (ul)
